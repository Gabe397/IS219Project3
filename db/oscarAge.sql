...
CREATE TABLE IF NOT EXISTS oscarage (
    ...
    `Column6` VARCHAR(22) CHARACTER SET utf8,
    PRIMARY KEY(`id`)
);

INSERT INTO oscarage (indexes,years,age,name,movie,Column6) VALUES
    (1, 1928, 44, 'Emil Jannings', 'The Last Command', NULL),
